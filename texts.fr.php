...
$contents["CAROUSEL_ALT_3"] = "Fait. Votre appareil est maintenant à jour !";
...
// Supported devices
$contents["SUPPORTED_DEVICES_TITLE"] = "Appareils supportés: ";
...
$contents["DEVICE_INFORMATION_ALT"] = "Connaître les caractéristiques de votre appareil";
$contents["DEVICE_INFORMATION_TITLE"] = "Connaître les caractéristiques de votre appareil";
$contents["DEVICE_INFORMATION_TEXT"] = "Oxygen Updater vous permet de connaître certaines caractéristiques de votre appareil. Vous pouvez connaître quel chipset votre appareil utilise, la quantité de RAM qu'il possède et savoir sous quelle version d'Android/Oxygen OS il fonctionne.";

$contents["DEVICE_SUPPORT_TITLE"] = "Supporte la plupart des appareils vendus par OnePlus";
$contents["DEVICE_SUPPORT_TEXT"] = "Oxygen Updater supporte la plupart des appareils vendus par OnePlus. Vous recevrez une notification push quand un nouveau appareil sera supporté. Vous pouvez la désactiver si vous le souhaitez.";
...
$contents["UPDATE_METHODS_TEXT"] = "Cette application supporte les méthodes de mise à jour incrémentales, complètes et Open Beta. Economisez de la bande passante et de l'espace de stockage en utilisant la méthode incrémentale ou téléchargez la mise à jour complète si vous voulez appliquer la mise à jour depuis une version plus ancienne ou avez un appareil rooté.";

$contents["FOOTER_DESCRIPTION"] = "Une application pour télécharger plus rapidement les mises à jour système pour les appareils fonctionnant sous OxygenOS.\nRequière un appareil OnePlus fonctionnant sous Oxygen OS.\n";
